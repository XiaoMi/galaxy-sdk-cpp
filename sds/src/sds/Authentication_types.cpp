...
int _kAppUserAuthProviderValues[] = {
  ...
  AppUserAuthProvider::WEIXIN_OAUTH
};
...
const std::map<int, const char*> _AppUserAuthProvider_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(6, _kAppUserAuthProviderValues, _kAppUserAuthProviderNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
...
OAuthInfo::~OAuthInfo() throw() {
}


void OAuthInfo::__set_xiaomiAppId(const std::string& val) {
  this->xiaomiAppId = val;
}

void OAuthInfo::__set_appUserAuthProvider(const AppUserAuthProvider::type val) {
  this->appUserAuthProvider = val;
}

void OAuthInfo::__set_accessToken(const std::string& val) {
  this->accessToken = val;
__isset.accessToken = true;
}

void OAuthInfo::__set_openId(const std::string& val) {
  this->openId = val;
__isset.openId = true;
}

void OAuthInfo::__set_macKey(const std::string& val) {
  this->macKey = val;
__isset.macKey = true;
}

void OAuthInfo::__set_macAlgorithm(const std::string& val) {
  this->macAlgorithm = val;
__isset.macAlgorithm = true;
}

const char* OAuthInfo::ascii_fingerprint = "F7DFEBC60B8CC55B2D69FDBE9C68A37B";
const uint8_t OAuthInfo::binary_fingerprint[16] = {0xF7,0xDF,0xEB,0xC6,0x0B,0x8C,0xC5,0x5B,0x2D,0x69,0xFD,0xBE,0x9C,0x68,0xA3,0x7B};

uint32_t OAuthInfo::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 5:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->macKey);
          this->__isset.macKey = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 6:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->macAlgorithm);
          this->__isset.macAlgorithm = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t OAuthInfo::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  oprot->incrementRecursionDepth();
  xfer += oprot->writeStructBegin("OAuthInfo");
  ...
  if (this->__isset.accessToken) {
    xfer += oprot->writeFieldBegin("accessToken", ::apache::thrift::protocol::T_STRING, 3);
    xfer += oprot->writeString(this->accessToken);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.openId) {
    xfer += oprot->writeFieldBegin("openId", ::apache::thrift::protocol::T_STRING, 4);
    xfer += oprot->writeString(this->openId);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.macKey) {
    xfer += oprot->writeFieldBegin("macKey", ::apache::thrift::protocol::T_STRING, 5);
    xfer += oprot->writeString(this->macKey);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.macAlgorithm) {
    xfer += oprot->writeFieldBegin("macAlgorithm", ::apache::thrift::protocol::T_STRING, 6);
    xfer += oprot->writeString(this->macAlgorithm);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
void swap(OAuthInfo &a, OAuthInfo &b) {
  using ::std::swap;
  swap(a.xiaomiAppId, b.xiaomiAppId);
  swap(a.appUserAuthProvider, b.appUserAuthProvider);
  swap(a.accessToken, b.accessToken);
  swap(a.openId, b.openId);
  swap(a.macKey, b.macKey);
  swap(a.macAlgorithm, b.macAlgorithm);
  swap(a.__isset, b.__isset);
}

OAuthInfo::OAuthInfo(const OAuthInfo& other14) {
  xiaomiAppId = other14.xiaomiAppId;
  appUserAuthProvider = other14.appUserAuthProvider;
  accessToken = other14.accessToken;
  openId = other14.openId;
  macKey = other14.macKey;
  macAlgorithm = other14.macAlgorithm;
  __isset = other14.__isset;
}
OAuthInfo& OAuthInfo::operator=(const OAuthInfo& other15) {
  xiaomiAppId = other15.xiaomiAppId;
  appUserAuthProvider = other15.appUserAuthProvider;
  accessToken = other15.accessToken;
  openId = other15.openId;
  macKey = other15.macKey;
  macAlgorithm = other15.macAlgorithm;
