...
std::ostream& operator<<(std::ostream& out, const Version& obj) {
  ...
  out << "Version(";
  out << "major="; (obj.__isset.major ? (out << to_string(obj.major)) : (out << "<null>"));
  out << ", " << "minor="; (obj.__isset.minor ? (out << to_string(obj.minor)) : (out << "<null>"));
  out << ", " << "patch="; (obj.__isset.patch ? (out << to_string(obj.patch)) : (out << "<null>"));
